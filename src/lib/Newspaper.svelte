<script lang="ts">
  ...
  let {children, heading, subheading = null,image = null, columns = null, meta = null,footerContent = null, headingTransitionName = null, featuredImage = null, featuredImageTransitionName = null}:{
    children: Snippet,
    heading: string,
...
<Panel hasBorder={true} hasPadding={true}>
  ...
  <h2 class='subheading' style:view-transition-name={headingTransitionName || 'newspaper-subheading'}>{subheading}</h2>
  {@render meta?.()}
  {#if featuredImage}
