<script lang="ts">
	...
	function subdomainFromHostname(host: string): string | null {
...
<footer>
	<div class="footer-content">
		<div class="block">
			<h6>Contact Me</h6>
			<p>
				Reach out to me today with any questions or concerns, or anything else I may be able to do
				for you!
			</p>
			...
			<form onsubmit={handleSubmit}>
				...
				<div class="input-wrapper">
					...
					<textarea id="contact-message" name="message" rows="4" required disabled={submitting}
					></textarea>
				</div>
		...
		<div class="block">
			...
			<h6>Usage</h6>
			<p>
				Use of this site constitutes your agreement to our <a href="/privacy-policy"
					>Privacy Policy</a
				>. The material on this site may not be reproduced, distributed, transmitted, cached or
				otherwise used, except with prior written permission of Its Miller Time Dev.
			</p>
...
<style lang="postcss">
	footer {
		...
		grid-template-columns:
			[l-margin] minmax(var(--side-margins), auto) [footer-content] minmax(0px, 1200px)
